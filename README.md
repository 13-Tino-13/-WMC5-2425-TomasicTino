...
Created a WMC repository for my exercises. Named it "-WMC5-2425-TomasicTino".
To keep track of my work, copied the file (LearningPath.md) into my repo and record my progress in the tables below.
Documented my progress by creating summaries and programming the examples.
...
1. Finish either the JavaScript Course on Codecademy or the one from freeCodeCamp
   ...
   | [freeCodeCamp - Learn JavaScript - Full Course for Beginners](https://www.youtube.com/watch?v=PkZNo7MFNFg)|   3h 27 min       | 0 %       |no       |
...
4. Work through the following video about Node.js and Express
   ...
   | Task      | Duration| Progress (in %) | Completed |
   |-----------|-----------|-----------|-----------|
   | [Node.js and Express.js - Full Course](https://www.youtube.com/watch?app=desktop&v=Oe421EPjeBE) |    8h 17min      | 0 %        |yes/no       |
